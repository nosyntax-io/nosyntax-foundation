...
import io.nosyntax.foundation.presentation.screen.web.util.LoadingState.Finished
import io.nosyntax.foundation.presentation.screen.web.util.LoadingState.Loading
...
public fun WebView(
    ...
    client: WebKitClient = remember { WebKitClient() },
    chromeClient: WebKitChromeClient = remember { WebKitChromeClient() },
