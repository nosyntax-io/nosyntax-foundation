package io.nosyntax.template.android.core
...
object Constants {
    ...
    const val WEB_ALLOW_CONTENT_ACCESS = true
    const val WEB_DOM_STORAGE_ENABLED = true
    const val WEB_DATABASE_ENABLED = true
    const val JAVASCRIPT_CAN_OPEN_WINDOWS_AUTOMATICALLY = true
    const val WEB_SET_GEOLOCATION_ENABLED = true
}